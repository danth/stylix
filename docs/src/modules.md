...
- `packages`: optional list of packages that the module affects. Used in
    generating homepage documentation.
- `homepages`: attribute set of homepages. Attribute names are used as
